...
model_path="/home/wenhao/Project/intern/kangyu/annotations+scripts+outputs/outputs/med-dpo/harvard/dpo_checkpoints/harvard_llava-med-lora-caption_stage-2_balanced_abc_only_report"
...
answer_file="/home/wenhao/Project/intern/kangyu/annotations+scripts+outputs/annotations+scripts/med-dpo/harvard/inference/${data_type}_report/answer-file_${model_path_basename}_${data_type}_${noised_suffix}fixedK-${fixedK}_report.jsonl"
